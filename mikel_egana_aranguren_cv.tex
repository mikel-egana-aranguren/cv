...
\begin{itemize}
	\item Semantic Web and Linked (Open) Data (Advanced): RDF, RDFS, SPARQL, OWL, SWRL, JSON-LD, OWL API, RDFLib, ONTO-PERL, Jena, Sesame, Stardog, Pubby, Prot\'eg\'e 4, TopBraid composer, CKAN
	...
	\item Project management (Basic): Jira, Trac
