...
\begin{tabular}{ll}
 2015-Present & {\bf Analyst} Eurohelp Consulting, S.L. \\
...
% 2016 & Scientific director of EHU's Bioinformatics University Specialist degree (http://bioinformatika.eus) \\
...
\begin{itemize}
	\item Semantic Web and Linked (Open) Data (Advanced): RDF, RDFS, SPARQL, OWL, SWRL, JSON-LD, OWL API, RDFLib, ONTO-PERL, Jena, Sesame, Virtuoso, Stardog, Blazegraph, Pubby, Prot\'eg\'e 4, TopBraid composer
	...
	\item Web (Basic): CKAN, Galaxy, Apache, Nginx, Tomcat, Jetty, lighttp, Solr/Lucene, Wordpress, Drupal, Jekyll, NodeJS
