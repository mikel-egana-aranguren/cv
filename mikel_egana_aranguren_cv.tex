...
\begin{itemize}
	\item Semantic Web and Linked (Open) Data (Advanced): RDF, RDFS, SPARQL, OWL, SWRL, SHACL, JSON-LD, RDFa, OWL API, RDFLib, ONTO-PERL, Jena, RDF4J, Virtuoso, Stardog, Blazegraph, Apache Marmotta, GraphDB, Pubby, Prot\'eg\'e 4, TopBraid composer, CKAN, D2RQ, Open Refine, Grafter
