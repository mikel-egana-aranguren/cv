...
\begin{itemize}
  ...
  \item Triple Stores: GraphDB, Stardog, Virtuoso, Blazegraph %neptune
  % \item Property Graph databases: Neo4j
  ...
  \item Open Data: CKAN
  \item Project management: Jira, Confluence, GitHub projects
\end{itemize}
