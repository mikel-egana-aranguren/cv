...
~\\
    ...
    \href{https://www.eccenca.com}{Eccenca GmbH} (Leipzig, Germany) \\
  %  Bilbo, Spain \\
...
%     Cell: & (0034) 656724785 \\
    @: 
& \href{mailto:mikel.egana.aranguren@gmail.com}{mikel.egana.aranguren@gmail.com} \\
...
I am a seasoned Linked Data expert, with hands-on experience in the design and development of data integration solutions, from ontology engineering to mapping of data sources to Knowledge Graphs. I started my career in an academic setting, applying Semantic Web technologies (RDF, SPARQL, OWL, SHACL) to the problem of data integration in the Life Sciences. As I moved from academia to the private sector, I have been applying the same technologies to other domains like Government Open Data and Enterprise Data. I have worked in different countries and participated in international projects.

Even though I have mainly worked as an arquitect of Linked Data systems, I also enjoy working with very technical problems. I am fluent in Java and comfortable using Unix systems and distributed version control systems like Git.

Being a biologist by training, I started my career as a bioinformatician. Therefore, I have also done some Bioinformatics work like analysing Metagenomics data.
...
\begin{tabular}{ll}
2018/12/02 - Present & {\bf Linked Data Consultant} Eccenca GmbH \\
