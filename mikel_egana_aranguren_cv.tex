...
\begin{tabular}{ll}
 ...
 2011-2014 & {\bf Marie Curie Cofund fellow} Ontology Engineering Group (Computer \\ 
	    ...
	    & Ontology Engineering and and Life Sciences Semantic Web \\
...
\begin{tabular}{ll}
	2016 - 2017 & Servicios Open Linked Data. EJIE (Sociedad Inform\'atica del Gobierno Vasco). \\
	            & (90.000 EUR) \\
	            & Linked Data implementation of Open Data Euskadi (\href{http://www.contratacion.euskadi.eus/w32-1084/es/contenidos/anuncio_contratacion/expx74j21656/es_doc/es_arch_expx74j21656.html}{Servicios Open Linked Data})\\
        2016 - 2020 & REPLICATE. Renaissance of Places with Innovative Citizenship And \\ 
                    ...
                    & 300.000 EUR).  \\
                    & Linked Open Data in Smart Cities (\href{http://replicate-project.eu/}{http://replicate-project.eu/}) \\
...
\begin{itemize}
	\item Semantic Web and Linked (Open) Data (Advanced): RDF, RDFS, SPARQL, OWL, SWRL, JSON-LD, RDFa, OWL API, RDFLib, ONTO-PERL, Jena, Sesame, Virtuoso, Stardog, Blazegraph, Apache Marmotta, GraphDB, Pubby, Prot\'eg\'e 4, TopBraid composer, CKAN, D2RQ, Open Refine, Grafter
	...
	\item Software development (Basic): Maven, Ant, SCons, Eclipse, Subversion, Mercurial, Git, Travis CI, Jenkins, CodeCov
